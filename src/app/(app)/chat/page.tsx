    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {rooms.length === 0 && data ? (
        <EmptyState
          ...
          title="아직 대화가 없습니다"
          description="요양보호사와 매칭되면 채팅이 시작됩니다"
          action={
            <Link
              href={isGuardian ? "/search/caregiver" : "/search/guardian"}
              className="mt-2 bg-primary-500 text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-primary-600 transition-colors"
            >
                ...
                <div className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-0.5">
                      ...
                      {unread > 0 && (
                        <Badge variant="danger" size="sm" className="ml-2 min-w-[20px] !bg-primary-500 !text-white !text-[10px] !font-bold !rounded-full !px-1.5 flex-shrink-0">
                          {unread > 99 ? "99+" : unread}
                        </Badge>
                      )}
                    </div>
